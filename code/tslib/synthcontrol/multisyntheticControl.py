...
class MultiRobustSyntheticControl(RobustSyntheticControl):
    ...
    def __init__(self, nbrMetrics, weightsArray, seriesToPredictKey, kSingularValuesToKeep, M, probObservation=1.0,
                 modelType='svd', svdMethod='numpy', otherSeriesKeysArray=[]):
        ...
        super(MultiRobustSyntheticControl, self).__init__(seriesToPredictKey, kSingularValuesToKeep, self.combinedM,
                                                          probObservation, modelType, svdMethod, otherSeriesKeysArray)
