...
from tslib.algorithms.alsWrapper import ALSWrapper as ALS
...
class ALSModel(SVDModel):
    ...
    def __init__(self, seriesToPredictKey, kFactors, N, M, probObservation=1.0, otherSeriesKeysArray=[],
                 includePastDataOnly=True):

        super(ALSModel, self).__init__(seriesToPredictKey, kFactors, N, M, probObservation=probObservation,
                                       svdMethod='numpy', otherSeriesKeysArray=otherSeriesKeysArray,
