...
global_events = [
    ...
    {'date': '3/19/20', 'event': 'Italy records more coronavirus-related \ndeaths than China', 'relevency': ['Italy']},
    ...
    {'date': '5/3/20', 'event': 'India extended its nationwide lockdown \nfor another two weeks',
    ...
    {'date': '4/6/20', 'event': 'Lowest number of new daily cases \nin three weeks', 'relevency': ["Italy"]},
