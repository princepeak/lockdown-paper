...
global_events = [
    ...
    {'date': '2/11/20', 'event': 'WHO announces name COVID-19', 'relevency': ['New York', 'New Jersey', 'Illinois', 'Italy', 'Spain']},
    ...
    {'date' : '1/31/20', 'event' : 'US ban entry for most foreign nationals who had traveled to China within the last 14 days', 'relevency': []},
    ...
    {'date' : '3/19/20', 'event' : 'China reported no new domestic cases for the first time since the start of the epidemic', 'relevency': []},
    ...
    {'date': '3/15/20', 'event': 'National lockdown due to the \nState of Alarm becomes effective', 'relevency': ["Spain"]},
